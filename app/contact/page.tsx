...
export default function ContactPage() {
  ...
  /** --- Nettoyage & protection DOMPurify --- **/
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!delayPassed || formData.honey.trim() !== '') {
      alert("Tentative suspecte détectée. Votre IP est enregistrée pour analyse.");
    ...
    if (attempts >= 3) {
      alert("Trop de tentatives. Votre IP a été signalée à l'administrateur.");
      setIsSubmitting(false);
      return;
    }
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-gray-50">
      <head>
        <title>Contact | Epropulse - IA & Digital accessibles à tous</title>
        <meta
          name="description"
          content="Contactez Epropulse — plateforme francophone de formation et services IA. Nous aidons jeunes, créateurs et entreprises à réussir avec le digital, même sans compétences techniques."
        />
      ...
      <section className="relative flex flex-col items-center text-center py-24 bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-800 text-white">
        <h1 className="text-5xl font-extrabold mb-4 tracking-tight">
          <span className="text-white drop-shadow-md">Contactez-nous</span>
        </h1>
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-10 md:p-16 border border-gray-100 flex flex-col md:flex-row gap-12">
          ...
          <div className="md:w-1/3 space-y-6">
            ...
            <p className="text-gray-600 text-sm mb-8 leading-relaxed">
              Vous pouvez nous écrire via le formulaire ou utiliser directement
